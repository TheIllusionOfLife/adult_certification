    ...
    skills: {
        ...
        offer2: [
            createKeySkill(
                ...
                '仲介術',
                'MEDIATION',
                '直接対決を避け、システムや第三者を介して問題を解決する技術。SOCIAL問題の社会的信用の新規獲得値を30%増幅します。',
    ...
    skills: {
        offer1: [
            createNormalSkill(
                's2_normal_02',
                '給与交渉力',
                '職場での経済的成果を高め、資産の新規獲得値を30%増幅します。',
        ...
        offer2: [
            createKeySkill(
                ...
                '証拠連鎖',
                'EVIDENCE_CHAIN',
                '重要な会話は記録すべし。LABOR問題の自律性の新規獲得値を30%増幅します。証拠があれば「言った言わない」は通用しません。',
    ...
    skills: {
        ...
        offer2: [
            ...
            createKeySkill(
                ...
                '複利感覚',
                'COMPOUND_SENSE',
                '時間を味方につける知恵。FINANCE問題の資産の新規獲得値を30%増幅します。',
    ...
    skills: {
        offer1: [
            createNormalSkill(
                's4_normal_02',
                '行政信頼',
                '行政との円滑な関係が社会的信用の新規獲得値を25%増幅します。',
                { type: 'cs_gain_amplification', value: 0.25 },
                true,
        ...
        offer2: [
            createKeySkill(
                ...
                '手続き主義',
                'DUE_PROCESS',
                '正しい手順を踏むことで身を守る。ADMIN問題の社会的信用の新規獲得値を30%増幅します。',
    ...
    skills: {
        offer1: [
            createNormalSkill(
                's5_normal_01',
                '制度理解',
                '社会保障制度の知識が社会的信用の新規獲得値を30%増幅します。',
                { type: 'cs_gain_amplification', value: 0.3 },
                true,
            ...
            createNormalSkill(
                's5_normal_02',
                '受給自律',
                '制度を主体的に活用する力が自律性の新規獲得値を30%増幅します。',
        ...
        offer2: [
            createKeySkill(
                ...
                'セーフティネット航法',
                'SAFETY_NET_NAVIGATION',
                '社会保障という航路図を読み、危機を乗り越える技術。HEALTH問題の自律性の新規獲得値を30%増幅します。',
    ...
    skills: {
        offer1: [
            ...
            createNormalSkill(
                's6_normal_01',
                '交渉自律',
                '対等な立場で交渉する力が自律性の新規獲得値を30%増幅します。',
                { type: 'autonomy_gain_amplification', value: 0.3 }
            ),
        ],
        offer2: [
            createKeySkill(
                ...
                '交渉プロトコル',
                'NEGOTIATION_PROTOCOL',
                '第三者や制度を介して交渉する技術。HOUSING問題の資産の新規獲得値を30%増幅します。',
    ...
    skills: {
        offer1: [
            ...
            createNormalSkill(
                's7_normal_02',
                '権利主張',
                '正当な権利を行使する力が自律性の新規獲得値を30%増幅します。',
                { type: 'autonomy_gain_amplification', value: 0.3 }
            ),
        ],
        offer2: [
            createKeySkill(
                ...
                '契約読解',
                'CONTRACT_LITERACY',
                '契約書を読み解き、不利な条項を見抜く目。LEGAL問題の自律性の新規獲得値を30%増幅します。',
    ...
    skills: {
        offer1: [
            createNormalSkill(
                's8_normal_01',
                '電子信用',
                'デジタル空間での信頼構築が社会的信用の新規獲得値を25%増幅します。',
                { type: 'cs_gain_amplification', value: 0.25 },
                true,
        ...
        offer2: [
            createKeySkill(
                ...
                '本人性衛生',
                'IDENTITY_HYGIENE',
                'デジタル空間で自分の身元を守る衛生習慣。SEC問題の自律性の新規獲得値を30%増幅します。',
    ...
    skills: {
        ...
        offer2: [
            createKeySkill(
                ...
                '被害最小化',
                'DAMAGE_CONTROL',
                '危機的状況で冷静に行動し、被害を最小限に抑える能力。DISASTER問題の自律性の新規獲得値を30%増幅します。',
