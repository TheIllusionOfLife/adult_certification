...
export const stage3Questions: Question[] = [
    // Q1: Knowledge (FINANCE) - Compound interest basics [SWAPPED A↔B]
    {
        id: "s3_q01",
        category: "FINANCE",
    ...
    // Q4: Knowledge (FINANCE) - Fixed vs variable rate loans [SWAPPED A↔B]
    {
        id: "s3_q04",
        category: "FINANCE",
    ...
    // Q5: Dilemma (FINANCE) - iDeCo vs NISA for retirement [SWAPPED A↔B]
    {
        id: "s3_q05",
        category: "FINANCE",
    ...
    // Q9: Dilemma + Lock (FINANCE) - Invest vs pay off debt [SWAPPED A↔B]
    {
        id: "s3_q09",
        category: "FINANCE",
    ...
    // Q10: Philosophy (FINANCE) - Money as tool vs master [HYPOTHETICAL + EFFECT FLIP] [SWAPPED A↔B]
    {
        id: "s3_q10",
        category: "FINANCE",
